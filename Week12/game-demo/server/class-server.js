...
exports.Server = class Server {
	...
	onPacket(msg, rinfo){
		...
		// lookup which client sent packet
		// if client doesnt exist, add to clients
		// if client does exist, give packet to client for processing
	...
	makeClient(rinfo){
		...
		this.sendPacketToClient(packet, client); // TODO: needs acknowledge
